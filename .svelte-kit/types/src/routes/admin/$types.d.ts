...
type LayoutRouteId = RouteId | "/admin" | "/admin/installation" | "/admin/invoices" | "/admin/invoices/[id]" | "/admin/leads" | "/admin/settings" | "/admin/tenants" | "/admin/tenants/[id]" | "/admin/tenants/new"
