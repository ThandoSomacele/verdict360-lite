...
<svelte:head>
  ...
  <meta name="description" content="Get in touch with Verdict 360. We're here to help transform your law practice with AI technology." />
</svelte:head>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p class="text-sm text-gray-500 mt-4">
              * AI Assistant available 24/7 for existing clients
            </p>
          </CardContent>
        </Card>
